...
if __name__ == "__main__":
    ...
    utils.plot_loss(mom_train_history["loss"],"Use momentum Training Loss", npoints_to_average=10)
    utils.plot_loss(mom_val_history["loss"], "Use momentum Validation Loss")
    ...
    utils.plot_loss(mom_train_history["accuracy"], "use momentum Training Accuracy")
    utils.plot_loss(mom_val_history["accuracy"], "use momentum Validation Accuracy")
